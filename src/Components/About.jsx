        ...
        <div className={styles.container}>
            ...
            <div className={styles.body}>
                <div className={styles.left}>
                    <p>
                    I am a passionate and skilled software developer specializing in JavaScript, React, Node.js, and MongoDB. With a strong background in front-end development, I focus on building responsive, user-friendly web applications that provide seamless experiences.
                    </p>
                    <p>
